...
Описание: Устройство, выполняющее арифметические (сложение, вычитание) и логические (AND, OR, XOR) операции. Необходимо описать принцип работы, графическое обозначение 4-разрядного АЛУ и указать количество и виды операций.
Билеты:
Билет 1, вопрос 2: 4-разрядное АЛУ, графическое обозначение.
Билет 18, вопрос 2: АЛУ, количество и виды операций.
Статус: Полностью отсутствует в Markdown-файле.
Шифратор
Описание: Устройство, преобразующее один активный вход (из нескольких) в двоичный код на выходе. Необходимо описать принцип работы, графическое обозначение и таблицу истинности (например, для 4-входового шифратора).
Билеты:
Билет 7, вопрос 2: Шифратор, графическое обозначение, таблица истинности.
Статус: Упоминается косвенно в контексте сдвигового регистра, но нет описания, графического обозначения или таблицы истинности.
Полусумматор
Описание: Логическая схема для сложения двух 1-разрядных чисел, выдающая сумму (S) и перенос (C). Необходимо описать принцип работы, графическое обозначение и таблицу истинности.
Билеты:
Билет 16, вопрос 2: Полусумматор, графическое обозначение, таблица истинности.
Статус: Полностью отсутствует в Markdown-файле.
Сумматор
Описание: Логическая схема для сложения двух 1-разрядных чисел с учётом входного переноса, выдающая сумму (S) и выходной перенос (C). Необходимо описать принцип работы, графическое обозначение и таблицу истинности.
Билеты:
Билет 17, вопрос 2: Сумматор, графическое обозначение, таблица истинности.
Статус: Полностью отсутствует в Markdown-файле.
Демультиплексор на 4 выхода
Описание: Устройство, распределяющее входной сигнал на один из нескольких выходов в зависимости от селекторных сигналов. Необходимо описать принцип работы, графическое обозначение и таблицу истинности для 4 выходов.
Билеты:
Билет 28, вопрос 2: Демультиплексор на 4 выхода, графическое обозначение, таблица истинности.
Статус: Полностью отсутствует в Markdown-файле.
